...
function calcular(): void {
  ...
  const elSalario = document.getElementById("salario") as HTMLInputElement;
  const elNome = document.getElementById("nome") as HTMLInputElement;
  const elPreco = document.getElementById("preco") as HTMLInputElement;
  const elQtdTotal = document.getElementById("quantidadeTotal") as HTMLInputElement;
  const elUnidade = document.getElementById("unidade") as HTMLSelectElement;
  const elQtdUso = document.getElementById("quantidadePorUso") as HTMLInputElement;
  const elUsos = document.getElementById("usos") as HTMLInputElement;
  ...
  const unidade = elUnidade.value as Unidade;
